...
ActiveRecord::Schema.define(version: 20_170_416_175_651) do
  ...
  create_table 'conversations', force: :cascade do |t|
    ...
    t.datetime 'created_at',  null: false
    t.datetime 'updated_at',  null: false
    t.index %w(author_id receiver_id), name: 'index_conversations_on_author_id_and_receiver_id', unique: true, using: :btree
