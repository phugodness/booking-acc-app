...
# Reservation.create!(user_id: 20, checkin_date: Date.new(2017, 1, 2), checkout_date: Date.new(2017, 1, 10), number_of_guest: 3, service_fee: 300)
# Status.create(code: '001', name: 'Waiting')
# Status.create(code: '002', name: 'Confirmed')
# Status.create(code: '003', name: 'Cancelled')
RoomReservation.create(room_id: 45, reservation_id: 1, status_id: 1)
